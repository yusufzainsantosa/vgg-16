...
def train_dataset(train_loader, val_loader, drivePath, k_index):
    ...
    for epoch in range(num_epochs): #I decided to train the model for 50 epochs
        ...
        cifar_path = os.path.join(model_path, "vgg16_model_k{}_{}epoch.pth".format(k_index + 1, epoch + 1))
        print("[INFO] save model vgg16_model_k{}_{}epoch.pth".format(k_index + 1, epoch + 1))
